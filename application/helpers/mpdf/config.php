...
$this->list_indent_first_level = 0;	// 1/0 yex/no to indent first level of lists
$this->list_number_suffix = '.';	// Content to follow a numbered lists marker e.g. '.' gives 1. or IV.; ')' gives 1) or a)
...
$this->defaultCSS = array(
	...
	'UL' => array(
		...
		'TEXT-INDENT' => '1.3em',	/* Custom effect - lists indent */
	),
	'OL' => array(
		'MARGIN' => '0.83em 0',		/* only applied to top-level of nested lists */
		'TEXT-INDENT' => '1.3em',	/* Custom effect - lists indent */
