...
$excl = array( 'HTML-CSS', 'DIRECTW', 'TABLES', 'ListItem', 'IMAGES-CORE',
...
<div><b>Notes</b>
<ul>
<li>HTML-CSS is required for many of the other functions to work including: Tables, ListItem, Backgrounds, Forms, Border-radius and all other CSS</li>
