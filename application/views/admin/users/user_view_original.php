        ...
        <div class="box-body my-form-body a_u_a_top_dv">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="email" name="a_u_a_suffix" class="form-control" id="a_u_a_suffix" value="<?=$user["suffix"];?>" disabled />
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-6">
            ...
            <div class="form-group">
              <div class="col-sm-6">
                  ...
                  <input type="text" name="a_u_a_mobile_no" class="form-control" id="a_u_a_mobile_no" value="<?=$user["phone"];?>" required disabled/>
              </div>
                <div class="col-sm-6">
                    <label class="control-label">Fax</label>
                    <input type="text" name="a_u_a_fax" class="form-control" id="a_u_a_fax" value="<?=$user["fax"];?>" required disabled/>
                </div>
            </div>
            <!--<div class="form-group">
              <div class="col-sm-6">
