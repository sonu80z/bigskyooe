...
ColVis.prototype = {
	...
	/**
	 * Rebuild the lists of buttons for this instance (i.e. if there is a column
	 * header update)
	 *  @method  fnRebuild
	 */
	rebuild: function ()
	...
	"_fnConstruct": function ( init )
	{
		...
		/* If columns are reordered, then we need to update our exclude lists and
	...
	/**
	 * Create the element used to contain lists the columns (it is shown and
	 * hidden as needed)
	...
	/**
	 * Show the show / hide lists and the background
	...
	/**
	 * Hide the show / hide lists and the background
...
ColVis.defaults = {
	...
	/**
	 * List of columns (integers) which should be excluded from the lists
	 *  @property aiExclude
	 *  @type     array
	 *  @default  []
	 */
	...
	/**
	 * Indicate if the column lists should be positioned by Javascript,
