            ...
            <div class="box-body my-form-body a_u_a_top_dv">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select id="a_u_a_facility" name="a_u_a_facility[]" class="form-control" multiple
                                data-live-search="true">
                            <?php $user_facilities = explode("=", $user["facility"])?>
                            <?php foreach ($facilities as $facility):?>
                                <option value="<?php echo $facility["id"]?>"
                                <?php
                                foreach ($user_facilities as $user_facility){
                                    if ($user_facility == $facility["id"]) echo "selected";}?>>
                ...
                <div class="form-group">
                    <div class="col-sm-3">
                        ...
                        <select name="a_u_a_role" class="form-control">
                            ...
                            <option value="7" <?php if ($user['role'] == 7) echo "selected"; ?>>Ordering Physician
                            </option>
                    ...
                    <div class="col-sm-3">
                        ...
                        <select name="a_u_a_state" class="form-control">
                            <option value="1" <?php if ($user['mainstate'] == 1) echo "selected"; ?>>Arizona</option>
                            <option value="2" <?php if ($user['mainstate'] == 2) echo "selected"; ?>>California</option>
                            <option value="3" <?php if ($user['mainstate'] == 3) echo "selected"; ?>>Colorado</option>
                            <option value="4" <?php if ($user['mainstate'] == 4) echo "selected"; ?>>Utah</option>
                        </select>
                    </div>
                    <div class="col-sm-3">
                        <label class="control-label">Secondary State *</label>
                        <select name="a_u_a_secondary_state" class="form-control">
                            <option value="1" <?php if ($user['secondarystate'] == 1) echo "selected"; ?>>Arizona
                            </option>
                            <option value="2" <?php if ($user['secondarystate'] == 2) echo "selected"; ?>>California
                            </option>
                            <option value="3" <?php if ($user['secondarystate'] == 3) echo "selected"; ?>>Colorado
                            </option>
                            <option value="4" <?php if ($user['secondarystate'] == 4) echo "selected"; ?>>Utah</option>
                        </select>
                    </div>
                    <div class="col-sm-3">
                        <br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <select name="af_subdivisions"
                                class="form-control" <?php if ($user['subdivision'] == '') echo "disabled"; ?>>
                    ...
                    <div class="col-sm-3">
                        ...
                        <select name="af_regions"
                                class="form-control" <?php if ($user['region'] == '') echo "disabled"; ?>>
                            <option value="0">Select Region</option>
                            <?php
                            foreach ($regions as $row) {
                                if ($user['region'] == $row['id']) {
                                    echo '<option value="' . $row["id"] . '" selected>' . $row["name"] . '</option>';
                                } else {
                                    echo '<option value="' . $row["id"] . '">' . $row["name"] . '</option>';
                                }
                    ...
                    <div class="col-sm-3">
                        ...
                        <select name="af_zone" class="form-control" <?php if ($user['zone'] == '') echo "disabled"; ?>>
                    ...
                    <div class="col-sm-6 row">
                        ...
                        <div class="col-md-6" id="permitted_state" style="display: none">
                            ...
                            <select name="a_u_a_permitted_state[]" id="a_u_a_permitted_state" class="form-control" multiple data-live-search="true">
                                <?php $user_permitted_states = explode("=", $user["permittedstate"]);?>

                                <option value="1" <?php foreach ($user_permitted_states as $user_permitted_state){
                                    if ($user_permitted_state == 1) echo "selected";}?>>Arizona</option>
                                <option value="2" <?php foreach ($user_permitted_states as $user_permitted_state){
                                    if ($user_permitted_state == 2) echo "selected";}?>>California</option>
                                <option value="3" <?php foreach ($user_permitted_states as $user_permitted_state){
                                    if ($user_permitted_state == 3) echo "selected";}?>>Colorado</option>
                                <option value="4" <?php foreach ($user_permitted_states as $user_permitted_state){
                                    if ($user_permitted_state == 4) echo "selected";}?>>Utah</option>
                            </select>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12 g_txt_right">
                        <button type="button" class="btn btn-info a_add_user_btn">Edit User</button>
